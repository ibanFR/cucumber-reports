...
import { Ruby } from '../components/icons/Ruby.tsx'
        ...
        <section className="my-8">
          <header className="text-center mb-8">
            <h2 className="text-4xl font-light">
              Start publishing <strong className="font-bold">in seconds</strong>
            </h2>
          ...
          <div className="flex flex-col md:flex-row gap-5">
            <div className="flex-1 flex flex-col justify-between gap-5 p-5 bg-white rounded-lg shadow-md">
              ...
              <FakeTerminal>
                <span className="text-slate-400">$</span> cucumber --publish
              </FakeTerminal>
            </div>
            <div className="flex-1 flex flex-col justify-between gap-5 p-5 bg-white rounded-lg shadow-md">
              <div className="text-center">
            ...
            <div className="flex-1 flex flex-col justify-between gap-5 p-5 bg-white rounded-lg shadow-md">
              ...
              <FakeTerminal>
                <span className="text-slate-400">$</span> cucumber-js --publish
              </FakeTerminal>
            </div>
          </div>
        </section>
